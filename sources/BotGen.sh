...
[[ ! -e "/bin/ShellBot.sh" ]] && \
wget -O /bin/ShellBot.sh \
"https://raw.githubusercontent.com/JotchuaDevz/TeleBotGen/master/ShellBot.sh" \
&>/dev/null
...
ShellBot.InlineKeyboardButton --button 'botao_donar' --line 1 --text 'Admin' --callback_data '1' --url 'http://t.me/Jotchua_DevzZ'
ShellBot.InlineKeyboardButton --button 'botao_donar' --line 2 --text 'Unirse Al Grupo' --callback_data '1' --url 'https://t.me/Request_Lab_X_Group'
